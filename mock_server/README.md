...
```json
{
  "has_update": true,
  "version": "1.2.3",
  "download_url": "http://192.168.1.100:3000/downloads/app-v1.2.3.apk",
...
```json
{
  "has_update": true,
  "version": "1.2.3",
  "download_url": "http://192.168.1.100:3000/ios/manifest.plist",
  "ios_manifest_url": "http://192.168.1.100:3000/ios/manifest.plist",
